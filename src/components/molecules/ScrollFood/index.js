  ...
  return (
    <View
      ...
      <View style={{height: '30%', padding:5, paddingHorizontal:10}}>
        ...
        <Text style={{fontSize:15, fontWeight:'bold', overflow:'hidden'}} numberOfLines={1}>{props.title}</Text>
        ...
        <Text style={{fontSize:13, fontWeight:'600', color:'#676767',overflow:'hidden', paddingLeft:15}} numberOfLines={1}>{props.desc}</Text>
